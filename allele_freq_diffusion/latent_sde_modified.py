...
######### Original code from latent_sde.py
######### Modify make_data() (either irregular sine or cosine) for
######### allele frequency diffusion data (start with strong positive selection which should be a bit easier)
######### Wrap the latent SDE to do Bayesian inference on Ns. 
